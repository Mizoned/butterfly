	...
	<div class="authorization">
		<div class="authorization__main">
			...
			<div class="authorization__header">
				<div class="authorization__title">Create in your account</div>
				<div class="authorization__description">It’s free and easy</div>
			</div>
...
<script setup lang="ts">
	...
	import TheLogotype from '@/components/commons/logotype/the-logotype.vue';
...
<style scoped lang="scss">
	.authorization {
		...
		&__header {
			...
			align-self: center;
			gap: 12px;
			color: var(--text-heading-dark-color);
			text-align: center;
		}
